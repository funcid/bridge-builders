...
enum class NameTagType(
    ...
    // Платные префкисы
    DORA("§dДора", -1, 49, MYTHIC),
    COURSED("§cКурсед", -1, 49, MYTHIC),
    COOL("§5Крутышка", -1, 49, MYTHIC),
    SAKAMOTO("§eСакамото", -1, 49, MYTHIC),
    GHOUL_V2("§41000-7", -1, 49, MYTHIC),
    LELUSH("§6Лелуш", -1, 49, MYTHIC),
    WOMANIZER("§dБабник", -1, 49, MYTHIC),
    CLOWN("§eКлоун", -1, 49, MYTHIC),
    PODPIVASNIK("§eПодпивасник", -1, 49, MYTHIC),
    PEPSICOL("§6Пепсикольный", -1, 49, MYTHIC),
    BOOSTER("§bБустер", -1, 39, MYTHIC),
    HEART_BREAKER("§cСердцеедка", -1, 39, MYTHIC),
    TUCHENCIA("§eТученция", -1, 39, MYTHIC),
    VIN_DIESEL("§eВин Дизель", -1, 39, MYTHIC),
    POSEIDON("§bПосейдон", -1, 29, MYTHIC),
    YAKUZA("§cЯкудза", -1, 29, MYTHIC),
    SPY("§0Шпион", -1, 29, MYTHIC),
    // Бесплатные префиксы
